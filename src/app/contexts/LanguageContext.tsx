...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.welcome.title': 'Welcome to Peace and Security Administration Bureau',
    ...
    'about.overview.content': 'The Peace and Security Administration Bureau - Public Organization Sector is a governmental institution under the Addis Ababa City Administration, established to promote peace, security, and the rule of law throughout the city.',
    ...
    // Footer
    'footer.description': 'Peace and Security Administration Bureau - Public Organization Sector, Addis Ababa City Administration',
    'footer.quicklinks': 'Quick Links',
    'footer.contact': 'Contact Information',
    'footer.followus': 'Follow Us',
    'footer.copyright': '© 2026 Peace and Security Administration Bureau. All rights reserved.',
  },
  am: {
    // Header (Amharic)
    'nav.home': 'መነሻ',
    ...
    'home.hero.cta2': 'አግኙን',
    'home.welcome.title': 'ወደ ሰላምና ደህንነት አስተዳደር ቢሮ እንኳን በደህና መጡ',
    ...
    'about.overview.content': 'የሰላምና ደህንነት አስተዳደር ቢሮ - የህዝብ ድርጅት ሴክተር በአዲስ አበባ ከተማ አስተዳደር የሚመራ የመንግስት ተቋም ሲሆን በከተማው ውስጥ ሰላምን፣ ደህንነትንና የህግ የበላይነትን ለማስፈን የተቋቋመ ነው።',
    ...
    // Footer (Amharic)
    'footer.description': 'የሰላምና ደህንነት አስተዳደር ቢሮ - የህዝብ ድርጅት ሴክተር፣ አዲስ አበባ ከተማ አስተዳደር',
    'footer.quicklinks': 'ፈጣን አገናኞች',
    'footer.contact': 'የእውቂያ መረጃ',
    'footer.followus': 'ይከተሉን',
    'footer.copyright': '© 2026 የሰላምና ደህንነት አስተዳደር ቢሮ። ሁሉም መብቶች የተጠበቁ ናቸው።',
  }
};
