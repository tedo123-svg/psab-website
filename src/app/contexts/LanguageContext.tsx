...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.mission.content': 'To make Addis Ababa a city where peace and security are protected and the rule of law is respected by implementing conflict early warning and rapid response systems, crime prevention and response; building peace values, managing religious and belief issues and diversity; enhancing resident participation and ownership of peace; strengthening security support organizations and diverse associations, establishing a support, monitoring and control system; implementing institutional partnerships and coordination mechanisms, and modernizing good governance and service delivery.',
    'about.vision.title': 'Vision',
    'about.vision.content': 'By 2022, Addis Ababa will be a city where peace and security prevail through public participation and ownership; and where the rule of law is guaranteed, making it a preferred city for living, working, and recreation.',
  ...
  am: {
    ...
    'about.vision.content': 'በ2022 አዲስ አበባ ከተማ በህዝብ ተሳትፎና ባለቤትነት ሰላምና ጸጥታ የሰፈነባት፤ የህግ የበላይነት የተረጋገጠባት ለኑሮ፣ ፡ለስራ እና ለመዝናኛ ተመራጭ የሆነች ከተማ ሆና ማየት፤',
