...
export function Contact() {
  ...
  const contactInfo = [
    { icon: MapPin, title: t('contact.location'), content: { en: 'Peace and Security Administration Bureau\nAddis Ababa, Ethiopia\nNear Meskel Square', am: 'የሰላምና ደህንነት አስተዳደር ቢሮ\nአዲስ አበባ፣ ኢትዮጵያ\nከመስቀል አደባባይ አቅራቢያ' }, color: 'green' },
